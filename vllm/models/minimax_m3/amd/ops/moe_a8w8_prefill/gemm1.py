...
"""MiniMax-M3 prefill MoE stage 1 for MXFP8 (a8w8): the a4w4 grouped gemm1
(``moe_a4w4_prefill/gemm1.py``) with fp8 operands.
...
def compile_moe_gemm1(
    *,
    ...
    Block order: ``tile_map`` from ``moe_a4w4_prefill.tile_map`` (expert-major,
    ...
    def kernel_gemm1(
        ...
        if block_valid:
            ...
            def _top_vmcnt(k2):  # k2 = parity of this step; step kc-1 gathered iff k2 == 0
            ...
            def _one_step(
                ...
                _gk = _min((kc_i + fx.Int32(3)) // fx.Int32(2), fx.Int32(K_ITERS // 2 - 1))
                ...
                c01f = mfma.call(
                    a0f, b1f_in, c01f, saR0, sbC, 1, k2, interleave=il, zero_acc=zero_acc
                )
                a1f = _a1
                ...
                c11f = mfma.call(
                    a1f, b1f_in, c11f, saR1, sbC, 1, k2, interleave=il, zero_acc=zero_acc
                )
                b0nf = _b0n
                b1nf = _b1n
            ...
            def _flat_sc(sc):
                saR0, saR1, sbC = sc
                return [_R(v) for v in saR0] + [_R(v) for v in saR1] + [_R(v) for v in sbC]
            ...
            c00_frag = mfma.call(a0_frag, b0_frag, c00_frag, saR0, sbC, 0, 0, interleave=il)
            a1_frag = _a1
            ...
            c10_frag = mfma.call(a1_frag, b0_frag, c10_frag, saR1, sbC, 0, 0, interleave=il)
            ...
            c00_frag = mfma.call(a0_frag, b0_frag, c00_frag, saR0, sbC, 0, 1, interleave=il)
            a1_frag = _a1
